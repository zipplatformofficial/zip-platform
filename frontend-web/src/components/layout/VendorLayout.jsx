...
const VendorLayout = () => {
  ...
  const menuItems = [
    { name: 'Dashboard', path: '/vendor', icon: FiHome, exact: true },
    { name: 'My Products', path: '/vendor/products', icon: FiPackage },
    { name: 'Add Product', path: '/vendor/products/new', icon: FiPlus },
    ...
    { name: 'Profile', path: '/vendor/profile', icon: FiUser },
            ...
            <div className="mb-6 p-4 bg-gradient-to-r from-pink-500/10 to-purple-500/10 border border-pink-500/20 rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-pink-500 text-xs font-medium">Vendor</p>
                </div>
              </div>
            </div>
